...
from my_widgets.text_input import CustomLineEdit, CustomTextEdit
...
class Ui_AddSound(object):
    def setupUi(self, AddSound):
        ...
        AddSound.resize(375, 635)
        AddSound.setMinimumSize(QSize(375, 635))
        AddSound.setMaximumSize(QSize(380, 635))
...
"}")
        ...
        self.hir = CustomLineEdit(self.horizontalWidget)
        ...
        self.kat = CustomLineEdit(self.horizontalWidget_2)
        ...
        self.hep = CustomLineEdit(self.horizontalWidget_3)
        ...
        self.kun = CustomLineEdit(self.horizontalWidget_4)
        ...
        self.horizontalWidget_5 = QWidget(self.main)
        ...
        self.horizontalLayout_7 = QHBoxLayout(self.horizontalWidget_5)
        self.horizontalLayout_7.setSpacing(6)
        self.horizontalLayout_7.setObjectName(u"horizontalLayout_7")
        self.horizontalLayout_7.setContentsMargins(0, 0, 0, 0)
        self.label_8 = QLabel(self.horizontalWidget_5)
        ...
        self.eng = CustomLineEdit(self.horizontalWidget_5)
        self.eng.setObjectName(u"eng")
        sizePolicy1.setHeightForWidth(self.eng.sizePolicy().hasHeightForWidth())
        self.eng.setSizePolicy(sizePolicy1)
        self.eng.setMinimumSize(QSize(275, 0))
        self.eng.setMaximumSize(QSize(375, 16777215))
        self.eng.setFont(font)

        self.horizontalLayout_7.addWidget(self.eng)

        self.verticalLayout.addWidget(self.horizontalWidget_5)

        self.horizontalWidget_6 = QWidget(self.main)
        ...
        self.horizontalLayout_10 = QHBoxLayout(self.horizontalWidget_6)
        self.horizontalLayout_10.setSpacing(6)
        self.horizontalLayout_10.setObjectName(u"horizontalLayout_10")
        self.horizontalLayout_10.setContentsMargins(0, 0, 0, 0)
        self.label_9 = QLabel(self.horizontalWidget_6)
        ...
        self.rus = CustomLineEdit(self.horizontalWidget_6)
        self.rus.setObjectName(u"rus")
        sizePolicy1.setHeightForWidth(self.rus.sizePolicy().hasHeightForWidth())
        self.rus.setSizePolicy(sizePolicy1)
        self.rus.setMinimumSize(QSize(275, 0))
        self.rus.setMaximumSize(QSize(375, 16777215))
        self.rus.setFont(font)

        self.horizontalLayout_10.addWidget(self.rus)
        ...
        self.mean = CustomTextEdit(self.widget_4)
        self.mean.setObjectName(u"mean")
        sizePolicy2 = QSizePolicy(QSizePolicy.Fixed, QSizePolicy.Expanding)
        sizePolicy2.setHorizontalStretch(0)
        sizePolicy2.setVerticalStretch(0)
        sizePolicy2.setHeightForWidth(self.mean.sizePolicy().hasHeightForWidth())
        self.mean.setSizePolicy(sizePolicy2)
        self.mean.setMinimumSize(QSize(275, 65))
        self.mean.setMaximumSize(QSize(375, 65))
        self.mean.setFont(font)
        self.mean.setStyleSheet(u"")
        ...
        self.mean2 = CustomTextEdit(self.widget_5)
        self.mean2.setObjectName(u"mean2")
        sizePolicy2.setHeightForWidth(self.mean2.sizePolicy().hasHeightForWidth())
        self.mean2.setSizePolicy(sizePolicy2)
        self.mean2.setMinimumSize(QSize(275, 65))
        self.mean2.setMaximumSize(QSize(375, 65))
        self.mean2.setFont(font)
        self.mean2.setStyleSheet(u"")
        ...
        self.keyboard.setStyleSheet(u"QPushButton{\n"
                                    ...
                                    "	border: 1px solid #8f8f91;\n"
                                    "    border-radius: 8px;\n"
                                    "	background-color: rgba(255, 245, 255, 150);\n"
                                    "	color: rgb(0, 0, 0);\n"
                                    "}\n"
                                    "")
        ...
        sizePolicy3.setHeightForWidth(self.btn_mark.sizePolicy().hasHeightForWidth())
        self.btn_mark.setSizePolicy(sizePolicy3)
    ...
    def retranslateUi(self, AddSound):
            ...
            self.label_6.setText(QCoreApplication.translate("AddSound",
                                                            u"\u0414\u043e\u0431\u0430\u0432\u043b\u0435\u043d\u0438\u0435 \u043d\u043e\u0432\u043e\u0433\u043e \u0437\u0432\u0443\u043a\u0430:",
                                                            None))
            self.close_btn.setText(QCoreApplication.translate("AddSound", u"\u00d7", None))
            self.label.setText(
                    QCoreApplication.translate("AddSound", u"\u0425\u0438\u0440\u0438\u0433\u0430\u043d\u0430:", None))
            self.hir.setPlaceholderText(QCoreApplication.translate("AddSound", u"\u3042\u3044\u3046\u3048\u304a", None))
            self.hir_auto.setText(QCoreApplication.translate("AddSound", u"auto", None))
            self.label_2.setText(
                    QCoreApplication.translate("AddSound", u"\u041a\u0430\u0442\u0430\u043a\u0430\u043d\u0430:", None))
            self.kat.setPlaceholderText(QCoreApplication.translate("AddSound", u"\u30a2\u30a4\u30a6\u30a8\u30aa", None))
            self.kat_auto.setText(QCoreApplication.translate("AddSound", u"auto", None))
            self.label_3.setText(
                    QCoreApplication.translate("AddSound", u"\u0425\u044d\u043f\u0431\u0451\u0440\u043d:", None))
            self.hep.setPlaceholderText(QCoreApplication.translate("AddSound", u"\u0430\u0438\u0443\u0435\u043e", None))
            ...
            self.kun.setPlaceholderText(QCoreApplication.translate("AddSound", u"\u0061\u0069\u0075\u0065\u006f", None))
            self.kun_auto.setText(QCoreApplication.translate("AddSound", u"auto", None))
            self.label_8.setText(QCoreApplication.translate("AddSound",
                                                            u"\u0410\u043d\u0433\u043b\u0438\u0439\u0441\u043a\u0438\u0439:",
                                                            None))
            self.eng.setPlaceholderText(QCoreApplication.translate("AddSound", u"ah, oh, uh", None))
            self.label_9.setText(
                    QCoreApplication.translate("AddSound", u"\u0420\u0443\u0441\u0441\u043a\u0438\u0439:", None))
            self.rus.setPlaceholderText(
                    QCoreApplication.translate("AddSound", u"\u0430\u0445, \u043e\u0445, \u0443\u0445", None))
            self.label_5.setText(
                    QCoreApplication.translate("AddSound", u"\u0417\u043d\u0430\u0447\u0435\u043d\u0438\u0435:", None))
            self.mean.setPlaceholderText(QCoreApplication.translate("AddSound",
                                                                    u"\u0412\u0432\u0435\u0434\u0438\u0442\u0435 \u0432\u0430\u0440\u0438\u0430\u043d\u0442\u044b \u0447\u0435\u0440\u0435\u0437 \", \"(\u043d\u0438\u0436\u043d\u0438\u0439 \u0440\u044f\u0434, 3\u044f \u043a\u043b\u0430\u0432\u0438\u0448\u0430 \u0441 \u043f\u0440\u0430\u0432\u0430) \u0442\u0430\u043a \u0436\u0435 \u043a\u0430\u043a \u0432 \"\u0410\u043d\u0433\u043b\u0438\u0439\u0441\u043a\u0438\u0439\" \u0438 \"\u0420\u0443\u0441\u0441\u043a\u0438\u0439\".",
                                                                    None))
            self.label_7.setText(QCoreApplication.translate("AddSound",
                                                            u"\u0423\u0442\u043e\u0447\u043d\u0451\u043d\u043d\u043e\u0435 \u0437\u043d\u0430\u0447\u0435\u043d\u0438\u0435:",
                                                            None))
            self.mean2.setPlaceholderText(QCoreApplication.translate("AddSound",
                                                                     u"\u0412\u0432\u0435\u0434\u0438\u0442\u0435 \u0432\u0430\u0440\u0438\u0430\u043d\u0442\u044b \u0447\u0435\u0440\u0435\u0437 \", \"(\u043d\u0438\u0436\u043d\u0438\u0439 \u0440\u044f\u0434, 3\u044f \u043a\u043b\u0430\u0432\u0438\u0448\u0430 \u0441 \u043f\u0440\u0430\u0432\u0430) \u0442\u0430\u043a \u0436\u0435 \u043a\u0430\u043a \u0432 \"\u0410\u043d\u0433\u043b\u0438\u0439\u0441\u043a\u0438\u0439\" \u0438 \"\u0420\u0443\u0441\u0441\u043a\u0438\u0439\".",
                                                                     None))
